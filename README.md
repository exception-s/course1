...
_Перегрузка функций: *(@Override)*_
...
*static* - поле_(единое для всех объектов)_: существует на уровне класса, а не объекта; Для каждого класса создается только один экземпляр статической переменной (переменой класса).
