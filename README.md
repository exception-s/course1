...
## Класс Object и его метода по умолчанию
---
...
---
* Наследуем только 1 класс, java не поддерживает наследование нескольких классо(см. "Проблема Алмаза"), также и "себя" нельзя наследовать. 
