...
* Checked(*"проверяемые"* ошибки): так называемые Compile time errors, ибо они возникают именно на стадии компиляции программы и без их обработки программа просто не скомпилируется.
